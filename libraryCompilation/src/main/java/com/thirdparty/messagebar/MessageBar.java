package com.thirdparty.messagebar;
...
public class MessageBar {
    ...
    private static final String STATE_MESSAGES = "com.thirdparty.messagebar.MessageBar.messages";
    private static final String STATE_CURRENT_MESSAGE = "com.thirdparty.messagebar.MessageBar.currentMessage";
    ...
    private static class Message implements Parcelable {
        ...
        public Message(Parcel p) {
            ...
            mToken = p.readParcelable(((Object) this).getClass().getClassLoader());
        }
